...
class GluttexImplNotification extends NotificationService {
  ...
  Future<NotificationList> getNotificationsByUserId(
    ...
    try {
      ...
      final url =
          '${GluttexConstants.apiBaseUrl}${GluttexConstants.getNotificationsEndpoint}/$userId';
  ...
  Future<GluttexNotification?> getNotificationById(
    ...
    try {
      ...
      final url =
          '${GluttexConstants.apiBaseUrl}${GluttexConstants.getNotificationByIdEndpoint}/$notificationId';
  ...
  Future<GluttexNotification?> markAsRead(
    ...
    try {
      ...
      final url =
          '${GluttexConstants.apiBaseUrl}${GluttexConstants.readNotificationEndpoint}/$notificationId/read';
  ...
  Future<int> markAllAsRead(
    ...
    try {
      ...
      final url =
          '${GluttexConstants.apiBaseUrl}${GluttexConstants.readAllNotificationsEndpoint}/$userId/read-all';
      developer.log(
  ...
  Future<bool> deleteNotification(
    ...
    try {
      ...
      final url =
          '${GluttexConstants.apiBaseUrl}${GluttexConstants.deleteNotificationEndpoint}/$notificationId';
  ...
  Future<int> deleteAllNotifications(
    ...
    try {
      ...
      final url =
          '${GluttexConstants.apiBaseUrl}${GluttexConstants.deleteAllNotificationsEndpoint}/$userId/all';
  ...
  Future<int> getUnreadCount(
    ...
    try {
      ...
      final url =
          '${GluttexConstants.apiBaseUrl}${GluttexConstants.unreadCountEndpoint}/$userId/unread-count';
  ...
  Future<GluttexNotification?> sendInvitation(
    ...
    try {
      ...
      final url =
          '${GluttexConstants.apiBaseUrl}${GluttexConstants.sendInvitationEndpoint}';
  ...
  Future<List<GluttexNotification>> bulkCreateNotifications(
    ...
    try {
      ...
      final url =
          '${GluttexConstants.apiBaseUrl}${GluttexConstants.bulkCreateNotificationsEndpoint}';
